      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-6xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-10">
          {SERVICES_DATA.map((service, index) => {
            ...
            return (
              <ScrollReveal key={service.id} delay={0.2 + index * 0.1} direction="up">
                <div
                  className="group flex flex-col items-start p-8 bg-card rounded-2xl border border-border transition-all duration-300 hover:shadow-lg hover:shadow-black/5 dark:hover:shadow-white/5 hover:border-primary/30 h-full"
                >
